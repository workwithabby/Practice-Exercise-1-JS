...
|---|----------|-------------|
| 1 | **MDAS Calculator** | Two numbers and computes Addition, Subtraction, Multiplication, Division, and Modulus. |
| 2 | **Age Calculator (10 Years from Now)** | Birth year, calculates current age using `Date`, and computes age 10 years from now. |
| 3 | **Circumference of a Circle** | A radius and computes the circumference using `2 × π × radius`. |
